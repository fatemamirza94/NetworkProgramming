...
//special constructor
	...
	//use hash for setting parameters
	public void setParam(String key, String value) {
		parameters.put(key,value);
	}
	
	//use hash for setting type
	public void setType(int value) {
		//TODO
		type=value;
	}
	
	//use hash for getting type
	public int getType() {
		return type;
		//TODO
	}
	
	//use hash for getting parameters
...
//create the hash and put it in the hash
	public void unpack() {
